...
export class PatientRegisterService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.patientRegisterUrl = "http://localhost:9003/api/v1/authentication-service/patient/register";
    this.loginUrl = "http://localhost:9003/api/v1/authentication-service/patient/login";
  }
