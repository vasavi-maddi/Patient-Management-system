...
export class PhysicianAvailabilityService {
  ...
  constructor(private http: HttpClient) {
    this.physicianAvailability = 'http://localhost:9007/api/v1/physician-availability/physician';
    this.putUrl = 'http://localhost:9007/api/v1/physician-availability/update-availability';
    this.deleteUrl = 'http://localhost:9007/api/v1/physician-availability/physician-available/';
    this.availablePhysician = 'http://localhost:9007/api/v1/physician-availability/physician-available/'
    this.updateStatus = "http://localhost:9007/api/v1/physician-availability/update-status";
    this.count = "http://localhost:9007/api/v1/physician-availability/count";
    this.findByEmail = "http://localhost:9007/api/v1/physician-availability/physician-details"
  }
