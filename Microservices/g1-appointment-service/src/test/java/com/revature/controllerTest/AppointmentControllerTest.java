...
//		mockMvc.perform(post("/api/v1/appointment-service/appointment",a)
...
//		mockMvc.perform(get("/api/v1/appointment-service/patient-appointment/1").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
...
//		mockMvc.perform(get("/api/v1/appointment-service/appointment/physician@gmail.com/04-04-2023/Accepted","physician@gmail.com","04-04-2023","Accepted").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
	...
	public void getOnlyAcceptedAppointments() throws Exception{
		...
		mockMvc.perform(get("/api/v1/appointment-service/appointment/Accepted","Accepted")
				.contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(status().isOk())
				.andExpect(jsonPath("$[0].acceptance").value("Accepted"));
	}
...
//		this.mockMvc
//				.perform(put("/appointment-service/appointment/{id}/{status}").contentType(MediaType.APPLICATION_JSON)
