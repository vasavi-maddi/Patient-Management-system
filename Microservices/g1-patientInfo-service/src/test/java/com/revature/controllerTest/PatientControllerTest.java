...
public class PatientControllerTest {
	...
	public void GetPatientByIdTest() throws Exception {
		...
		mockMvc.perform(get("/api/v1/patient-info/patient/160").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void getPatientsTest() throws Exception {
		...
		mockMvc.perform(get("/api/v1/patient-info/patient").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void putPatientTest() throws Exception {
		...
		mockMvc.perform(put("/api/v1/patient-info/patient/160",p1).contentType(MediaType.APPLICATION_JSON)
